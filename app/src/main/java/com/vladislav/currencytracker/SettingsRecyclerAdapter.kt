...
class SettingsRecyclerAdapter(private val rate: DayExchangeRates, private val settings: MutableList<SettingsItem>) :
    ...
    override fun onBindViewHolder(holder: SettingsRecyclerAdapter.SettingsHolder, position: Int) {
        ...
        holder.bindSettingsItems(currencyItem, isSelected)
    }
    ...
    class SettingsHolder(v: View) : RecyclerView.ViewHolder(v) {
        ...
        fun bindSettingsItems(currencyItem: CurrencyItem, isSelected: Boolean) {
            this.currencyItem = currencyItem
            this.isSelected = isSelected
            view.rv_switch.isSelected = isSelected
